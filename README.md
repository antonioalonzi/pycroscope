...
* **Live Spatial Measurement:** Measure distances by default, switch to angle mode for vertex-based angle readings, add text annotations to snapped frames, and remove a single edit without clearing the whole frame.
